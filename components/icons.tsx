...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5a3 3 0 1 0-5.993.142"/><path d="M18 13a3 3 0 1 0-4.472-2.5"/><path d="M18 5a3 3 0 1 0-5.993.142"/><path d="M12 13a3 3 0 1 0-4.472-2.5"/><path d="M11.5 14.5a3 3 0 1 0 4.472 2.5"/><path d="M6 5a3 3 0 1 0-1.53 5.5"/><path d="M6 13a3 3 0 1 0-1.53 5.5"/><path d="M12.5 14.5a3 3 0 1 0 4.472 2.5"/><path d="M11.5 8.5v.5"/><path d="M9.5 5.5v.5"/><path d="M14.5 5.5v.5"/><path d="M9.5 12.5v.5"/><path d="M15 11.5v-1"/><path d="M14.5 17.5v.5"/><path d="M7 8.5v.5"/><path d="M7 16.5v.5"/><path d="M16 14.5v-1"/></svg>
);
